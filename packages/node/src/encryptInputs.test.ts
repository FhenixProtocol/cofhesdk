...
describe('@cofhesdk/node - Encrypt Inputs', () => {
  ...
  describe('Real Encryption - Single Values', () => {
    ...
    it('should encrypt uint8 with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
    ...
    it('should encrypt uint16 with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
    ...
    it('should encrypt uint32 with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
    ...
    it('should encrypt uint64 with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
    ...
    it('should encrypt uint128 with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
    ...
    it('should encrypt address with real TFHE', async () => {
      await cofhesdkClient.connect(publicClient, walletClient);
  ...
  describe('Real Encryption - Multiple Values', () => {
