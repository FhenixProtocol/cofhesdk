...
description: Submit decrypted plaintext and its signature back to a contract
---

# Writing Decrypt Result to Contract

This page covers the “decrypt → write tx” flow after you run [`decryptForTx`](./decrypt-to-tx.mdx): you take `{ ctHash, decryptedValue, signature }` and submit a transaction that your contract can verify.
...
1. Run [`decryptForTx`](./decrypt-to-tx.mdx) and get a result object with:

- `ctHash`
- `decryptedValue`
- `signature`

2. Ensure the Solidity parameter type you pass matches your encrypted type.
