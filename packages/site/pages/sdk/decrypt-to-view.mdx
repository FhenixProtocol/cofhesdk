...
// Creates a acp if needed, stores it, and selects it as the active acp.
...
const client = createCofheClient(config);
declare const ctHash: `0x${string}`;
declare const acpHash: `0x${string}`;
declare const account: `0x${string}`;
// ---cut---
