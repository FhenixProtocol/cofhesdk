...
// ---cut---
const result = await client.decryptForTx(ctHash).withPermit(permitHash).execute();
...
declare const ctHash: `0x${string}`;
// ---cut---
const result = await client.decryptForTx(ctHash).setChainId(11155111).withPermit().execute();
