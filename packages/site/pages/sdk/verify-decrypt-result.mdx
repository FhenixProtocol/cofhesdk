...
:::note
Verification is a **cryptographic sanity check**. It does not validate acps/ACL policy, and it does not guarantee your contract will accept the plaintext (e.g. range/type constraints).
:::
