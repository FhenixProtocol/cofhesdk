...
4. Submit a transaction to your contract and pass the encrypted inputs as `InE*` parameters (see [Writing encrypted data to a contract](./writing-encrypted-data-to-contract.mdx)).
...
See [Writing Encrypted Data — Hash plus proof](./writing-encrypted-data-to-contract.mdx#hash-plus-proof) for a full contract call example.
