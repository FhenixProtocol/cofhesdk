...
Override the address that "owns" the encrypted input. Only that address will be allowed to use the encrytped inputs on-chain. Defaults to the account from the connected `WalletClient`.
