...
4. Generates a self-usage ACP for the signer
...
:::info
`createClientWithBatteries` generates a self-ACP automatically, so most test operations (encrypting inputs, decrypting for view, decrypting for tx) work immediately without any extra setup.
:::
