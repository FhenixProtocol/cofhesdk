...
declare const counter: Contract;
// ---cut---
await hre.cofhe.mocks.withLogs('counter.increment()', async () => { // [!code focus]
...
:::info
`enableLogs` accepts an optional label string. If provided, it prints a labeled header immediately — useful when you want to mark a section of output at a known point and disable logging asynchronously later.
:::
...
export default {
  solidity: '0.8.28',
  cofhe: {
    logMocks: false, // disable FHE op logs globally // [!code focus]
  },
};
```
