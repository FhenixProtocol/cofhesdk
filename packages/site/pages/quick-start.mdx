...
```bash [npm]
npm install @cofhe/hardhat-plugin@^0.3.2 @cofhe/sdk@^0.3.2 @fhenixprotocol/cofhe-contracts@^0.1.0
```

```bash [pnpm]
pnpm add @cofhe/hardhat-plugin@^0.3.2 @cofhe/sdk@^0.3.2 @fhenixprotocol/cofhe-contracts@^0.1.0
```

```bash [yarn]
yarn add @cofhe/hardhat-plugin@^0.3.2 @cofhe/sdk@^0.3.2 @fhenixprotocol/cofhe-contracts@^0.1.0
```
...
| --------------------------------- | -------- | ---------------------------------------------------------------------- |
| `@cofhe/hardhat-plugin`           | `^0.3.2` | Extends Hardhat with `hre.cofhe`, deploys mock contracts automatically |
| `@cofhe/sdk`                      | `^0.3.2` | Client-side encryption, decryption, and permit management              |
| `@fhenixprotocol/cofhe-contracts` | `^0.1.0` | `FHE.sol` — the Solidity library imported by your contracts            |

:::note
`@fhenixprotocol/cofhe-contracts@0.1.0` requires `@cofhe/sdk` version `>= 0.3.2`.
:::
