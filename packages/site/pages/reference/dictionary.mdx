...
## Handle (aka “ciphertext handle”, often named `ctHash` in code)

A **handle** is the on-chain identifier for an encrypted value.
...
## Encrypted input (`EncryptedItemInput`, `InEuint*`)
