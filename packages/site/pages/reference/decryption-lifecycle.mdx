...
- `permit_denied`, `permit_expired`, `permit_invalid`, `permit_malformed` — permit was rejected or malformed.
- `not_publicly_allowed` — no permit was supplied and the handle isn't publicly decryptable.
