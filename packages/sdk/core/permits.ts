...
const storeActivePermit = async (permit: ACP, publicClient: any, walletClient: any) => {
...
const createSharing = async (
  ...
  return createPermitWithSign(options, publicClient, walletClient, ACPUtils.createSharingAndSign);
};
