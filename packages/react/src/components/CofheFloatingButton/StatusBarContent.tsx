...
const ConnectionStatus: React.FC = () => {
  ...
  return (
    <div className="cofhe-panel w-full h-full flex px-4 items-center justify-between">
      {/* Logo Icon */}
...
const statusTextColorMap: Record<CofheStatusVariant, string> = {
  error: 'text-red-500',
  warning: 'text-yellow-500',
  info: 'text-blue-500',
};

const statusBorderColorMap: Record<CofheStatusVariant, string> = {
...
const ActiveStatusContent: React.FC<{ status: CofheStatus }> = ({ status }) => {
  ...
  return (
    <div
      className={cn(
        'cofhe-panel w-full h-full flex px-4 items-center justify-between',
