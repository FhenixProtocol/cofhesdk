    ...
    <div className="flex items-center gap-1.5">
      ...
      <button
        ...
        className={cn(
          ...
          'cofhe-text-primary opacity-60 hover:opacity-100 transition-opacity',
...
export const CopyButton: React.FC<CopyButtonProps> = ({ text, size = 14, className }) => {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className={cn('cofhe-text-primary opacity-50 hover:opacity-100 transition-opacity cursor-pointer', className)}
