  ...
  return (
    <div
      ...
      className={cn(
        ...
        'cofhe-hover-overlay transition-colors',
        'cursor-pointer'
      )}
    >
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="min-w-0 flex-1">
          ...
          {showDestination && (
            <div className="text-xxxs opacity-70 cofhe-text-primary truncate leading-tight">→ {destinationSymbol}</div>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <div className="w-24 text-right whitespace-nowrap tabular-nums">
          {usdValue ? (
            <span className="text-sm opacity-70 cofhe-text-primary inline-block w-full text-right">{usdValue}</span>
          ) : (
