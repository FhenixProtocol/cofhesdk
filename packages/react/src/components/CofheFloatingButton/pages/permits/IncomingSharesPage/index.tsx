...
import { useIncomingShares, useImportFromChain, useRemoveShare } from '@/hooks/permits/index.js';
...
import type { IncomingShare } from '@cofhe/sdk/permits';
  ...
  const importMutation = useImportFromChain({
    onSuccess: () => {
      addToast({
        ...
        description: 'The imported ACP is now your active permit.',
      });
      navigateTo(FloatingButtonPage.Permits);
    },
    onError: (error) => {
