    ...
    <PageContainer
      ...
      content={
        <div className="flex flex-col gap-4 pr-1">
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <TokenIcon
                    ...
                    className={cn(
                      ...
                      'cofhe-icon-bg',
                      'border border-[var(--cofhe-button-default-border)]',
                      'flex items-center justify-center flex-shrink-0 overflow-hidden'
                    )}
                  />
                  <div className="min-w-0">
                    <div className="text-xl font-semibold cofhe-text-primary truncate">{token.name}</div>
                  </div>
                </div>

                <div className="text-2xl font-semibold cofhe-text-primary tabular-nums">{formatted}</div>
          ...
          {rows.length === 0 && <div className="text-sm opacity-70 cofhe-text-primary">No claimable tokens.</div>}
        </div>
      }
    />
  );
