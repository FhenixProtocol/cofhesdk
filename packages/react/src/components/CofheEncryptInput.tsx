    ...
    <div className="w-full">
        ...
        <div className="flex-1">
          <div className={inputContainerClasses} data-testid={testId}>
            <input
              ...
              data-testid={testId ? `${testId}-input` : 'cofhe-encrypt-input'}
            />
            ...
            <div className="cofhe-dropdown-container" ref={dropdownRef}>
              <button
                ...
                disabled={disabled || isEncrypting}
                data-testid={testId ? `${testId}-type-selector` : 'cofhe-type-selector'}
              >
                <ShieldIcon />
                <ChevronDownIcon />
              </button>
          ...
          {showProgress && (
            <div
              ...
              data-testid={testId ? `${testId}-progress` : 'cofhe-encrypt-progress'}
            >
              ...
              <div className={progressContainerClasses}>
                <div
                  ...
                  data-testid={testId ? `${testId}-progress-bar` : 'cofhe-encrypt-progress-bar'}
                />
              </div>
            </div>
          )}
      ...
      {hasError && errorMessage && (
        <p
          ...
          data-testid={testId ? `${testId}-error` : 'cofhe-encrypt-error'}
        >
          {errorMessage}
        </p>
      )}
