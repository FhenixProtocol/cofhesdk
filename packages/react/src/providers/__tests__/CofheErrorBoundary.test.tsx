...
function makeHandledCofheError(msg = 'permit missing') {
  return new CofheError({ code: CofheErrorCode.PermitNotFound, message: msg });
}
...
const errorFallbacks = [
  {
    checkFn: (e: unknown) => e instanceof CofheError && (e as CofheError).code === CofheErrorCode.PermitNotFound,
