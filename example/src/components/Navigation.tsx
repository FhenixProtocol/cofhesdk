...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <div className={`w-80 h-screen ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-r overflow-y-auto`}>
      <div className="p-6">
        {/* Header */}
        <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <div className={`text-sm p-2 rounded ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'}`}>
            CoFHE SDK Ready
          </div>
        </div>
